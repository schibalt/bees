...
double BnchFunc_USS_002_Shekelfox10(double *position, int *dimension, int *incv)
{
...
float BnchFunc_USS_002_Shekelfox10(float *position, int *dimension, int *incv)
{
