...
//
double EvlFunc(double *position, int *dimension, int *incv, char *funcname)
{
...
double BnchFunc_USS_002_Shekelfox5(double *position, int *dimension, int *incv)
{
  
   ///  Name               	Shekel¡¦s Foxholes Problem (FX)
   ///  Function           f(x)= 
...
float BnchFunc_USS_002_Shekelfox5(float *position, int *dimension, int *incv)
{
